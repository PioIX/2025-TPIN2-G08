...
<p>Bueno para empezar el juego diseñamos un sistema de inicio de sesion y uno de registro para aquellos que no tengan usuario creado, esto principalmente fue para tener cierto orden de quie juega contra quien, su historial de partidas, su actividad en el juego y demas</p>
