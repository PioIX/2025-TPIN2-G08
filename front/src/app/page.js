        ...
        <>
            ...
            {showAdminOption && (
                ...
                <div className="modalAdmin">
                    <h2>¡Bienvenido!</h2>
                    <button className="btn jugar" onClick={() => {
                        router.replace(`/lobby`);
                    }}>
                        Jugar
                    </button>
                            ...
                            <div className="user-listDelete">
                                ...
                                return (
                                        <label className="user-itemDelete" key={user.id_user}>
                                            <input type="checkbox" checked={deleteId.includes(user.id_user)} onChange={(e) => {
                                                if (e.target.checked) {
            ...
            <div className={"container"}>
                ...
                <div className={"form"}>
                    ...
                    <div className="input-container">
                        <input type="email" className={"input"} placeholder="Mail" value={email} onChange={(e) => setEmail(e.target.value)}/>
                    </div>
                    <div className="input-container">
                        <input type={showPassword ? "text" : "password"} className="input" placeholder="Contraseña" value={password} onChange={(e) => setPassword(e.target.value)}/>
                    ...
                    <div className={"buttons"}>
                        ...
                        <a className={"link"} type="button" onClick={() => router.replace(`/register`)}>
                            Registrarse
                        </a>
                    </div>
                </div>
